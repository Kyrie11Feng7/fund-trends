...
(function () {
  ...
  style.textContent = [
    ...
    '.signal-table-wrap{overflow:auto;max-height:70vh;margin-top:8px;border-radius:var(--radius-md);border:1px solid var(--border-color);}',
    ...
    '.signal-table th{color:var(--text-secondary);font-weight:600;background:var(--bg-secondary);position:sticky;top:0;z-index:2;}',
    '.signal-table tbody td{background:var(--bg-card);}',
